        ...
        <div class="container">
          ...
          <article class="media v-center">
            ...
            <div class="media-content">
              <div class="content">
                <p>
                  Created <strong>{{ meetupCreator.name }}</strong>
                </p>
              </div>
            </div>
          </article>
            ...
            <aside class="is-medium menu">
              <div class="meetup-side-box">
                <div class="meetup-side-box-date m-b-sm">
                  <p><b>Date</b></p>
                  <p>{{ meetup.startDate | dateFormat }}</p>
                </div>
                <div class="meetup-side-box-date m-b-sm">
                  <p><b>Time</b></p>
                  ...
                  <div class="media-content">
                    <div class="content is-medium">
                      <div class="post-content">
                        <!-- Post User Name -->
                        <strong class="author">Milos Jeremic</strong>
                        <!--{{post.user.name}}-->
                        {{ " " }}
                        <!-- Post Updated at -->
                        <small class="post-time">{{
                          post.updatedAt | dateFormat("LLL")
                        }}</small>
                        <br />
...
export default {
  ...
  methods: {
    ...mapActions("meetup", ["fetchMeetupById"]),
